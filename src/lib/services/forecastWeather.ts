...
const HOURLY_PARAMS = 'temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability,weather_code,wind_speed_10m,wind_direction_10m';
...
export async function fetchForecast(
    ...
    const url = `${WEATHER_FORECAST_API_BASE_URL}?latitude=${latitude}&longitude=${longitude}`
        ...
        + (prefersFahrenheit ? '&temperature_unit=fahrenheit' : '');
